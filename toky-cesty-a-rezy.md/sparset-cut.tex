...
\begin{array}{r c}
	...
	\forall e \in E & \sum_{e \in \in \mathcal{P}_{st}} x_{p} \leq c(e) \\
	& x \geq 0
\end{array}
$$
...
\begin{array}{r c}
	& \max f \\
	\forall i \in [k] & \sum_{p \in \mathcal{P}_{i}} x_{p} \geq f \cdot d_{i} \\
	\forall e \in E & \sum_{i = 0}^{k} \sum_{e \in \in \mathcal{P}_{i}} x_{p} \leq c(e) \\
	& x \geq 0
\end{array}
$$
...
\begin{array}{r c}
	...
	\forall i \in [k] \forall p \in \mathcal{P}_{i} & \sum_{e \in p} x_{e} -y_{i} \geq 0 \\
	& x,y \geq 0
\end{array}
$$
...
\begin{array}{r c}
	...
	\forall i \in [k] \forall p \in \mathcal{P}_{i} & \sum_{e \in p} x_{e} \geq y_{i} \\
	& \sum_{i = 1}^{k} d_{i}y_{i} \geq 1 \\
	\forall e \in E & x_{e} \in \{0,1\} \\
	\forall i \in [k] & y_{i} \in \{0,1\}
\end{array}
$$
...
\begin{array}{r c}
	...
	\forall e \in E & x_{e} \geq 0 \\
	\forall i \in [k] & y_{i} \geq 0
\end{array}
$$
...
\begin{proof}[Proof of Lemma A \ref{A}]
	...
	$$
	= \frac{\sum_{S \subseteq V} \lambda_{S} \sum_{e \in E} c(e) \mu_{S}(e)}{\sum_{S \subseteq V} \lambda_{S} \sum_{i =1}^{k} d(i)  \mu_{S}(s_{i},t_{i})} \geq \min_{S \subseteq V} \rho(S)
	$$
