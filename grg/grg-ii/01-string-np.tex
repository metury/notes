...
\begin{proof}
	Take AT with minimum number of crossings. 1. is satisfied by the definition. 2. otherwise minimality is broken (see Fig. \ref{second-before} and \ref{second-after}), 3. again the minimality is broken and lastly 4. follows from GRG1.
