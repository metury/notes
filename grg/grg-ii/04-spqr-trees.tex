...
\begin{figure}[!ht]\centering
	\begin{subfigure}{.5\textwidth}\centering
		\begin{tikzpicture}[node distance = 40, main/.style = {draw, circle, fill}, thick]
			...
			\draw (2) -- (4) node[midway, above left] {4};
			\draw (4) -- (5) node[midway, above left] {5};
			\draw (3) -- (5) node[midway, above left] {6};
			\draw (2) -- (5) node[midway, above left] {7};
			\draw (1) -- (6) node[midway, above left] {10};
			\draw (5) -- (7) node[midway, above left] {11};
			\draw (6) -- (8) node[midway, above left] {12};
			\draw (8) -- (9) node[midway, above left] {13};
			\draw (7) -- (9) node[midway, above left] {14};
			\draw (7) -- (10) node[midway, above left] {15};
			\draw (6) -- (10) node[midway, above left] {16};	
		\end{tikzpicture}
	\end{subfigure}
