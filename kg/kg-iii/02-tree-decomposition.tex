...
\begin{figure}[!ht]\centering
	\begin{subfigure}{0.3\textwidth}\centering
		\begin{tikzpicture}[node distance={14mm}, thick, main/.style = {draw, circle}]
			\node[main] (1) {A};
			\node[main] (2) [below right of=1, color = Green] {B};
			\node[main] (3) [above right of=2] {C};
			\node[main] (4) [below right of=3] {D};
			\node[main] (5) [below of=4, color = cyan] {E};
			\node[main] (6) [below left of=5] {F};
			\node[main] (7) [left of=6, color = orange] {G};
	...
	\begin{subfigure}{0.35\textwidth}\centering
		\begin{tikzpicture}[node distance={14mm}, thick, main/.style = {draw, circle}]
			\node[main] (1) {\tiny{A\textcolor{orange}{G}H}};
			\node[main] (2) [below right of=1] {{\tiny A\textcolor{Green}{B}\textcolor{orange}{G}}};
			\node[main] (3) [below right of=2] {{\tiny \textcolor{Green}{B}\textcolor{orange}{G}\textcolor{cyan}{E}}};
			\node[main] (4) [above right of=3] {{\tiny \textcolor{Green}{B}\textcolor{cyan}{E}D}};
			\node[main] (5) [above right of=4] {{\tiny \textcolor{Green}{B}CD}};
			\node[main] (6) [below of=3] {{\tiny \textcolor{cyan}{E}\textcolor{orange}{G}F}};
			\path
			(1) edge (2)
			(2) edge (3)
			(3) edge (4)
	...
	\begin{subfigure}{0.3\textwidth}\centering
		\begin{tikzpicture}[node distance={14mm}, thick, main/.style = {draw, circle}]
			\node[main] (1) {\textcolor{Green}{B}};
			\node[main] (2) [below right of=1] {\textcolor{cyan}{E}};
			\node[main] (3) [below left of=1] {\textcolor{orange}{G}};
			\path
			(1) edge (2)
			(2) edge (3)
			(3) edge (1);
